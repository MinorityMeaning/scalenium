...
val gh = GitHubSettings(org = "com.github.artemkorsakov", proj = "scalenium", publishOrg = "com.github.artemkorsakov", license = apache2)

val mainDev =
  Developer("Artem Korsakov", "@artemkorsakov", "artemkorsakov@mail.ru", new java.net.URL("http://github.com/artemkorsakov"))
...
lazy val Scalenium = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeDocumentationUrl := "/scalenium/api/com.github.artemkorsakov/index.html",
